...
<body>
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			<a class="logo navbar-logo f-l mr-10 hidden-xs"
				href="/aboutHui.shtml">信诺</a> <span
				class="logo navbar-slogan f-l mr-10 hidden-xs">律师管理</span> <a
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="javascript:;"
							onclick="picture_add('添加资讯','picture-add.html')"><i
								class="Hui-iconfont">&#xe613;</i> 领域</a></li>
						<li><a href="javascript:;"
							onclick="product_add('添加资讯','product-add.html')"><i
								class="Hui-iconfont">&#xe620;</i> 论坛</a></li>
						<li><a href="javascript:;"
			...
			<ul class="cl">
				...
				<!-- websocket信息发送 -->
				<li id="Hui-msg"><a onclick="dianJi()" title="消息"><span
						class="badge badge-danger" id="chat" onclick="dianJi()"></span><i
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			<dt>
				<i class="Hui-iconfont">&#xe613;</i>法律领域<i
					class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="wwlist.do" data-title="法律领域"
						href="javascript:void(0)">领域管理</a></li>
				</ul>
			</dd>
		</dl>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="个人中心"
					data-href="houtai/geren.jsp">个人中心</span> <em></em></li>
			</ul>
		</div>
...
function myselfinfo(){
	layer.open({
		...
		shade:0.4,
		title: '查看信息',
		content: '<div align="center">邮箱:${sessionScope.email}</div><div align="center">地址:${sessionScope.address}</div><div align="center">服务时间:${sessionScope.time}</div><div align="center">服务地区:${sessionScope.service_Address}</div><div align="center">联系方式:${sessionScope.phonenum}</div><div align="center">帮助次数:${sessionScope.helpcount}</div>'
	});
}
