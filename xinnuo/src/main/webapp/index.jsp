    ...
    <!-- start header -->
		<header>
			<div class="top center">
				...
				<div class="right fr">
					<div class="gouwuche fr"><a href="entrust.do">发帖</a></div>
					<div class="fr">
						<ul>
							...
							<div class="left fl">
								...
								<c:forEach items="${lawtype.categoryList}" var="second">
									<div class="xuangou_left fl">
										<a href="getLawInfo.do?id=${second.id}">
											<span class="fl">${second.typeName}</span>
										</a>
									</div>
									<div class="xuangou_right fr"><a href="getLawyerId.do?id=${lawtype.id}">选择</a></div>
									<div class="clear"></div>
									</c:forEach>
								</div>	
						</div>
