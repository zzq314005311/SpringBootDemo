...
<body>
	...
	<div class="grzxbj">
		<div class="selfinfo center">
			...
			<div class="rtcont fr">
				<div class="ddzxbt">回复帖子</div>
				<form action="inseid.do">
				<input type="hidden" value="${id}" name="id"></input>
					<select name="" style="width: 200px;height: 30px;margin: 5px">
						<option value="1">匿名</option>
						<option value="2">实名</option>
					</select> 
					详细内容:<textarea style="width: 900px;height: 300px;resize: none" name="content">
					</textarea>
					<input type="submit" style="width: 100px;height: 30px;margin-left: 800px" value="回复">
				</form>
			</div>
			<div class="clear"></div>
		</div>
