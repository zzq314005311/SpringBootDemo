...
<script type="text/javascript">
    ...
    var wsUri = "ws://127.0.0.1:8080/xinnuo/websocket";
...
<div class="qqBox">
	<div class="BoxHead">
		<div class="headImg">
			<img src="image/${findAll.head}"/>
		</div>
		<div class="internetName">${selectLawyer.name}</div>
	</div>
	<div class="context">
		...
		<div class="conRight">
			<div class="Righthead">
				...
				<%-- <div class="headName">专业:
				<c:forEach items="${asList} " var="major">
				${major}
				</c:forEach> </div> --%>
				<h4>为了确保安全,您的聊天记录可能会被保存！</h4>
			...
			<div class="RightFoot">
				...
				<div class="inputBox">
					<textarea  id="in" name="message" style="width: 99%;height: 75px; border: none;outline: none;" name="" rows="" cols="">
